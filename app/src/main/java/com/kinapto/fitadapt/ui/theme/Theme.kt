 ...
 */
@Composable
private fun dynamicKinAptoLightColorScheme(theme: ThemeOption): androidx.compose.material3.ColorScheme {
...
fun KinAptoTheme(
    ...
    MaterialTheme(
        colorScheme = dynamicKinAptoLightColorScheme(currentTheme),
        typography = KinAptoTypography,
        shapes = KinAptoShapes,
        content = content
    )
}
