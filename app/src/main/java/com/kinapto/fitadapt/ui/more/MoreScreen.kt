...
// =============================================================
package com.kinapto.fitadapt.ui.more
...
fun MoreScreen(
    ...
    Column(
        ...
        MenuCard(
            ...
            title = "Dati Personali (Paziente)",
            subtitle = "Esporta i tuoi dati in formato JSON o QR",
        ...
        MenuCard(
            icon = Icons.Outlined.QrCode,
            title = "Dati Clinici (Operatore)",
            subtitle = "Esporta CRF per il monitoraggio clinico (REDCap)",
