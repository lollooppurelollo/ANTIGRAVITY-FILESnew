...
// =============================================================
package com.kinapto.fitadapt.data.local.datastore
 ...
 * File: kinapto_user_settings.preferences_pb (nella cartella interna dell'app)
 *
 ...
 * - Passphrase del database → in kinapto_crypto_prefs (CryptoManager)
 * - Hash password sezione protetta → in kinapto_security_prefs (PasswordManager)
 * - Dati paziente → nel database Room cifrato
 */
private val Context.userSettingsDataStore by preferencesDataStore(
    name = "kinapto_user_settings"
)
